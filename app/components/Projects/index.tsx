                    ...
                    <div className="w-full sm:w-3/4">
                        <div className="rounded-lg">
                            ...
                            <ul className="flex flex-wrap gap-x-2 gap-y-3">
                                ...
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">API</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-6 rounded-lg md:hover:bg-green-500/5  py-6 px-0 md:px-4 transition-all duration-300 ease-in-out group cursor-pointer hover:shadow-lg">
                    ...
                    <div className="w-full sm:w-3/4">
                        <div className="rounded-lg">
                            ...
                            <ul className="flex flex-wrap gap-x-2 gap-y-3">
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">NextJS</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">Laravel</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">Pusher</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">TailwindCSS</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">JWT Auth</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-6 rounded-lg md:hover:bg-green-500/5  py-6 px-0 md:px-4 transition-all duration-300 ease-in-out group cursor-pointer hover:shadow-lg">
                    ...
                    <div className="w-full sm:w-3/4">
                        <div className="rounded-lg">
                            ...
                            <ul className="flex flex-wrap gap-x-2 gap-y-3">
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">WordPress</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">Sage</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">REST</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">TailwindCSS</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">SCSS</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-6 rounded-lg md:hover:bg-green-500/5  py-6 px-0 md:px-4 transition-all duration-300 ease-in-out group cursor-pointer hover:shadow-lg">
                    ...
                    <div className="w-full sm:w-3/4">
                        <div className="rounded-lg">
                            ...
                            <ul className="flex flex-wrap gap-x-2 gap-y-3">
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">React</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">Redux</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">Laravel</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">SCSS</li>
                                <li className="bg-green-200 dark:bg-green-200 dark:bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">TailwindCSS</li>
                            </ul>
