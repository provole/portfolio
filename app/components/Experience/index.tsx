                    ...
                    <div className="w-full sm:w-3/4">
                        <div className="rounded-lg">
                            ...
                            <ul className="flex flex-wrap gap-x-2 gap-y-3">
                                ...
                                <li className="bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">PHP</li>
                                ...
                                <li className="bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">JavaScript</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="w-full sm:w-3/4">
                        <div className="rounded-lg">
                            ...
                            <ul className="flex flex-wrap gap-x-2 gap-y-3">
                                <li className="bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">JavaScript</li>
                                <li className="bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">PHP</li>
                                <li className="bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">jQuery</li>
                                <li className="bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">CMS</li>
                                <li className="bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">Emails</li>
                                <li className="bg-green-500/10 text-green px-4 py-1.5 text-xs rounded-full">Integrations</li>
                            </ul>
                        </div>
                    </div>
                </div>
